...
- [DONE] Step 5: Create tools (Base Tool, Weather Tool, Calculator Tool, Time Tool, Web-Search Tool)  
- [DONE] Step 6: Create the Tool Manager  
...
- [DONE] Step 12: Creating memory manager and extractor
